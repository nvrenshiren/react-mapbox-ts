(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("React"), require("mapboxgl"), require("mapbox-gl/dist/mapbox-gl.css"));
	else if(typeof define === 'function' && define.amd)
		define(["React", "mapboxgl", "mapbox-gl/dist/mapbox-gl.css"], factory);
	else if(typeof exports === 'object')
		exports["ReactMapBox"] = factory(require("React"), require("mapboxgl"), require("mapbox-gl/dist/mapbox-gl.css"));
	else
		root["ReactMapBox"] = factory(root["React"], root["mapboxgl"], root["mapbox-gl/dist/mapbox-gl.css"]);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.LoadImage = exports.AddImage = exports.CustomLayer = exports.ResterDemSource = exports.RasterSource = exports.VideoSource = exports.ImageSource = exports.CanvasSource = exports.VectorSource = exports.useForceUpdate = exports.Layer = exports.GeoJSONSource = exports.Popup = exports.Marker = exports.withMap = exports.MapContext = exports.Map = void 0;
var canvas_source_1 = __importDefault(__webpack_require__(11));
exports.CanvasSource = canvas_source_1.default;
var geojson_source_1 = __importDefault(__webpack_require__(12));
exports.GeoJSONSource = geojson_source_1.default;
var image_source_1 = __importDefault(__webpack_require__(13));
exports.ImageSource = image_source_1.default;
var layer_1 = __importDefault(__webpack_require__(14));
exports.Layer = layer_1.default;
var map_1 = __importDefault(__webpack_require__(15));
exports.Map = map_1.default;
var marker_1 = __importDefault(__webpack_require__(17));
exports.Marker = marker_1.default;
var popup_1 = __importDefault(__webpack_require__(9));
exports.Popup = popup_1.default;
var raster_source_1 = __importDefault(__webpack_require__(22));
exports.RasterSource = raster_source_1.default;
var raster_dem_source_1 = __importDefault(__webpack_require__(23));
exports.ResterDemSource = raster_dem_source_1.default;
var forceUpdate_1 = __importDefault(__webpack_require__(3));
exports.useForceUpdate = forceUpdate_1.default;
var vector_source_1 = __importDefault(__webpack_require__(24));
exports.VectorSource = vector_source_1.default;
var video_source_1 = __importDefault(__webpack_require__(25));
exports.VideoSource = video_source_1.default;
var context_1 = __webpack_require__(4);
Object.defineProperty(exports, "MapContext", { enumerable: true, get: function () { return context_1.MapContext; } });
var withmap_1 = __webpack_require__(26);
Object.defineProperty(exports, "withMap", { enumerable: true, get: function () { return withmap_1.withMap; } });
var load_image_1 = __importDefault(__webpack_require__(27));
exports.LoadImage = load_image_1.default;
var add_image_1 = __importDefault(__webpack_require__(10));
exports.AddImage = add_image_1.default;
var custom_layer_1 = __importDefault(__webpack_require__(28));
...
function addEvents(eventsMap, props, map, layerId) {
...
function updateEvents(listeners, nextProps, map, eventsMap, layerId) {
    var keyList = Object.keys(eventsMap);
...
Object.defineProperty(exports, "__esModule", { value: true });
var mapbox_gl_1 = __importDefault(__webpack_require__(6));
var react_1 = __webpack_require__(0);
...
Object.defineProperty(exports, "__esModule", { value: true });
var fast_deep_equal_1 = __importDefault(__webpack_require__(2));
var react_1 = __webpack_require__(0);
...
*/
var aa=__webpack_require__(0),n=__webpack_require__(19),r=__webpack_require__(20);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));
...
var _1 = __webpack_require__(1);
var forceUpdate_1 = __importDefault(__webpack_require__(3));
var RasterSource = react_1.forwardRef(function (props, ref) {
    var isMounted = react_1.useRef(false);
    var forceUpdate = forceUpdate_1.default();
    var map = react_1.useContext(_1.MapContext).map;
    var rasterRef = react_1.useRef();
    var prevPropsRef = react_1.useRef(__assign({}, props));
    var currentPropsRef = react_1.useRef(__assign({}, props));
    currentPropsRef.current = props;
    var children = props.children, id = props.id;
...
var _1 = __webpack_require__(1);
var forceUpdate_1 = __importDefault(__webpack_require__(3));
var RasterDemSource = react_1.forwardRef(function (props, ref) {
    var isMounted = react_1.useRef(false);
    var forceUpdate = forceUpdate_1.default();
    var map = react_1.useContext(_1.MapContext).map;
    var rasterDemRef = react_1.useRef();
    var prevPropsRef = react_1.useRef(__assign({}, props));
    var currentPropsRef = react_1.useRef(__assign({}, props));
    currentPropsRef.current = props;
    var children = props.children, id = props.id;
    ...
    var initSource = react_1.useCallback(function () {
        var currentProps = currentPropsRef.current;
        if (!(map === null || map === void 0 ? void 0 : map.getSource(sourceID))) {
            map === null || map === void 0 ? void 0 : map.addSource(sourceID, __assign(__assign({}, currentProps.option), { type: 'raster-dem' }));
            map === null || map === void 0 ? void 0 : map.on('sourcedata', getSource);
        }
    }, []);
    var removeSource = react_1.useCallback(function () {
    ...
    var getSource = react_1.useCallback(function () {
        var currentProps = currentPropsRef.current;
        rasterDemRef.current = map === null || map === void 0 ? void 0 : map.getSource(sourceID);
        if (!rasterDemRef.current || !(map === null || map === void 0 ? void 0 : map.isSourceLoaded(sourceID))) {
            return;
        }
...
exports.default = RasterDemSource;
...
var _1 = __webpack_require__(1);
var forceUpdate_1 = __importDefault(__webpack_require__(3));
var VectorSource = react_1.forwardRef(function (props, ref) {
    var isMounted = react_1.useRef(false);
    var forceUpdate = forceUpdate_1.default();
    var map = react_1.useContext(_1.MapContext).map;
    var vectorRef = react_1.useRef();
    var prevPropsRef = react_1.useRef(__assign({}, props));
    var currentPropsRef = react_1.useRef(__assign({}, props));
    currentPropsRef.current = props;
    var children = props.children, id = props.id;
    ...
    var initSource = react_1.useCallback(function () {
        var currentProps = currentPropsRef.current;
        if (!(map === null || map === void 0 ? void 0 : map.getSource(sourceID))) {
            map === null || map === void 0 ? void 0 : map.addSource(sourceID, __assign(__assign({}, currentProps.option), { type: 'vector' }));
            map === null || map === void 0 ? void 0 : map.on('sourcedata', getSource);
        }
    }, []);
    var removeSource = react_1.useCallback(function () {
    ...
    var getSource = react_1.useCallback(function () {
        var currentProps = currentPropsRef.current;
        vectorRef.current = map === null || map === void 0 ? void 0 : map.getSource(sourceID);
        if (!vectorRef.current || !(map === null || map === void 0 ? void 0 : map.isSourceLoaded(sourceID))) {
            return;
        }

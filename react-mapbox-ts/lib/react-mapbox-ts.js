...
Object.defineProperty(exports, "__esModule", { value: true });
var map_1 = __importDefault(__webpack_require__(6));
exports.Map = map_1.default;
var feature_1 = __importDefault(__webpack_require__(9));
exports.Feature = feature_1.default;
var context_1 = __webpack_require__(1);
exports.MapContext = context_1.MapContext;
var withmap_1 = __webpack_require__(10);
exports.withMap = withmap_1.withMap;
var marker_1 = __importDefault(__webpack_require__(11));
...
Object.defineProperty(exports, "__esModule", { value: true });
var mapbox_gl_1 = __importDefault(__webpack_require__(2));
var react_1 = __importStar(__webpack_require__(0));
var context_1 = __webpack_require__(1);
var events_1 = __webpack_require__(3);
var fast_deep_equal_1 = __importDefault(__webpack_require__(7));
...
var Map = react_1.default.forwardRef(function (props, ref) {
    ...
    var DidUpdate = react_1.useCallback(function () {
        if (map) {
            ...
            var didZoomUpdate = prevProps.zoom !== currentProps_1.zoom &&
                currentProps_1.zoom !== map.getZoom();
            var didBearingUpdate = prevProps.bearing !== currentProps_1.bearing &&
                currentProps_1.bearing !== map.getBearing();
            var didPitchUpdate = prevProps.pitch !== currentProps_1.pitch &&
                currentProps_1.pitch !== map.getPitch();
            var didCenterUpdate = utils_1.diffLngLat(map.getCenter(), currentProps_1.center);
            if (currentProps_1.maxBounds) {
                var didMaxBoundsUpdate = prevProps.maxBounds !== currentProps_1.maxBounds;
                if (didMaxBoundsUpdate) {
                    map.setMaxBounds(currentProps_1.maxBounds);
                }
            }
            if (currentProps_1.fitBounds) {
                var fitBounds_1 = prevProps.fitBounds;
                ...
                if (didFitBoundsUpdate ||
                    !fast_deep_equal_1.default(prevProps.fitBoundsOptions, currentProps_1.fitBoundsOptions)) {
            ...
            if (!!currentProps_1.style && !fast_deep_equal_1.default(prevProps.style, currentProps_1.style)) {
                map.setStyle(currentProps_1.style);
            }
            if (prevProps.renderWorldCopies !== currentProps_1.renderWorldCopies) {

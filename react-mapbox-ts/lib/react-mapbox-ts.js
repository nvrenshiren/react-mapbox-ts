...
var GeoJSONSource = react_1.forwardRef(function (props, ref) {
    ...
    var reRender = react_1.useCallback(function () {
        ...
        var currentProps = currentPropsRef.current;
        var layers = (_a = map === null || map === void 0 ? void 0 : map.getStyle().layers) === null || _a === void 0 ? void 0 : _a.filter(function (item) { return item.source === sourceID; });
        if (typeof currentProps.option.data !== 'string' &&
            (!(map === null || map === void 0 ? void 0 : map.getSource(sourceID)) || !(layers === null || layers === void 0 ? void 0 : layers.length))) {
            sourceRef.current = undefined;
            forceUpdate();
            initSource();
        }
...
var Layer = react_1.forwardRef(function (props, ref) {
    ...
    var initLayer = react_1.useCallback(function () {
        ...
        map === null || map === void 0 ? void 0 : map.addLayer(layOption, before || undefined);
    }, []);
    react_1.useEffect(function () {
        if (!isMounted.current) {
            isMounted.current = true;
...
var VectorSource = react_1.forwardRef(function (props, ref) {
    console.log('removeVectorSource');
    var isMounted = react_1.useRef(false);
    var forceUpdate = forceUpdate_1.default();
    var map = react_1.useContext(_1.MapContext).map;

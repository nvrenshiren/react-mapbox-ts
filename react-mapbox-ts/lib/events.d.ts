...
export declare function addEvents<T = any, U = any>(eventsMap: EventMapping<T, U>, props: Partial<T>, map: mapboxgl.Map | mapboxgl.Marker, layerId?: string): Listeners<T>;
export declare function updateEvents<T = any, U = any>(listeners: Listeners<T>, nextProps: Partial<T>, map: mapboxgl.Map | mapboxgl.Marker, eventsMap: EventMapping<T, U>, layerId?: string): Listeners<T>;
export {};
